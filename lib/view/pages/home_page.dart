                          ...
                          children: [
                            Container(
                              ...
                              child: CalorieProgressIndicator(
                                ...
                                calorieConsumed: homeViewModel.totalCalorieConsumed,
                                calorieGoal: homeViewModel.totalCalorieGoal,
                                name: "Kcal available",
                              ),
                            ),
                            Container(
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () {
                                        homeViewModel.updateSelectedMeal("Breakfast");
                                      },
                                      child: CalorieProgressIndicator(
                                        gradient: AppGradients.greenGradient,
                                        calorieConsumed: homeViewModel.breakfastCalorie,
                                        calorieGoal: homeViewModel.breakfastGoal,
                                        name: "Kcal",
                                        totalCalorie: false,
                                        isSelected: homeViewModel.selectedMeal == "Breakfast",
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () {
                                        homeViewModel.updateSelectedMeal("Lunch");
                                      },
                                      child: CalorieProgressIndicator(
                                        gradient: AppGradients.redGradient,
                                        calorieConsumed: homeViewModel.lunchCalorie,
                                        calorieGoal: homeViewModel.lunchGoal,
                                        name: "Kcal",
                                        picture: AppPicture.afternoonPicture,
                                        totalCalorie: false,
                                        color: AppColors.lunchBG,
                                        isSelected: homeViewModel.selectedMeal =="Lunch",
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          homeViewModel.updateSelectedMeal("Dinner");
                                        });
                                      },
                                      child: CalorieProgressIndicator(
                                        totalCalorie: false,
                                        gradient: AppGradients.blueGradient,
                                        calorieConsumed: homeViewModel.dinnerCalorie,
                                        calorieGoal: homeViewModel.dinnerGoal,
                                        name: "Kcal",
                                        picture: AppPicture.moonPicture,
                                        color: AppColors.dinnerBG,
                                        isSelected: homeViewModel.selectedMeal == "Dinner",
                                      ),
                                    ),
                                  ),
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () {
                                        homeViewModel.updateSelectedMeal("Snack");
                                      },
                                      child: CalorieProgressIndicator(
                                        gradient: AppGradients.purpleGradient,
                                        calorieConsumed: homeViewModel.snackCalorie,
                                        calorieGoal: homeViewModel.snackGoal,
                                        name: "Kcal",
                                        picture: AppPicture.snackPicture,
                                        totalCalorie: false,
                                        color: AppColors.snackBG,
                                        isSelected: homeViewModel.selectedMeal == "Snack",
                                      ),
                                    ),
                                  ),
                                ],
                              ...
                              SizedBox(height: 32),
                              dailyMealsCard(
                                  calorieConsumed: homeViewModel.calorieConsumed,
                                  calorieGoal: homeViewModel.calorieGoal,
                                  isSelected:homeViewModel.selectedMeal
                              ),
                              SizedBox(height: 32),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
